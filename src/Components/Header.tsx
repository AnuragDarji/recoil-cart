  ...
  return (
    <AppBar position='static' color='default' elevation={0} sx={{ borderBottom: (theme) => `1px solid ${theme.palette.divider}` }}>
      <Toolbar sx={{ flexWrap: 'wrap' }}>
        ...
        <Button href='https://mui.com/material-ui/getting-started/templates/sign-up/' variant='outlined' sx={{ my: 1, mx: 1.5 }}>
          Sign Up
        </Button>
        <Button href='https://mui.com/material-ui/getting-started/templates/sign-in/' variant='outlined' sx={{ my: 1, mx: 1.5 }}>
          Login
        </Button>
      </Toolbar>
    </AppBar>
