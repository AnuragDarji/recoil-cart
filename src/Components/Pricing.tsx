...
function PricingContent() {
  ...
  // function to get random item names
  const getRandomItem = () => {
    const items = ['Apple', 'Banana', 'Orange', 'Pineapple', 'Strawberry', 'Watermelon'];
          ...
          {tiers.map((tier) => (
            ...
            <Grid item key={tier.title} xs={12} sm={tier.title === 'Enterprise' ? 12 : 6} md={4}>
              <Card>
                ...
                <CardActions>
                  <Button onClick={buttonHandler} fullWidth variant={tier.buttonVariant as 'outlined' | 'contained'}>
                    {tier.buttonText}
                  </Button>
                </CardActions>
              </Card>
